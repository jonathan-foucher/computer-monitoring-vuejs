  ...
  watch: {
    dataset: {
      ...
      handler(newValue) {
        ...
        this.chart.data.datasets[0].backgroundColor[0] = this.getColorWithAlpha(
          this[this.getChartColor(newValue)],
          0.3
        );
        this.chart.data.datasets[0].borderColor[0] = this[
          this.getChartColor(newValue)
        ];

        this.chart.options.elements.center.text = Math.round(newValue) + "%";
        this.chart.options.elements.center.color = this[
          this.getChartColor(newValue)
        ];
